export default function Page() {
  return (
    <div className="flex-1 h-screen my-3 relative top-14 w-screen">
      <div className=" h-4/5 min-w-max bg-white border rounded m-10">
        <div className="p-3 w-full">
          <p className="text-xl">รายละเอียดการติดต่อ</p>
          <div className="p-4">
            <>
              <iframe
